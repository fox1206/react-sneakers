    ...
    <div className="wrapper clear">
      ...
      <div className="content p-40">
        ...
        <div className="d-flex">
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/1.jpg" alt="picture" />
            ...
            <div className="d-flex justify-between align-center mt-20">
              ...
              <button className="button">
                <img width={11} height={11} src="/img/add.svg" alt="picture"/>
              </button>
            </div>
          </div>
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/2.jpg" alt="picture" />
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/3.jpg" alt="picture" />
            <h5 className="mt-10">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center mt-20">
              <div className="d-flex flex-column">
                <span>Цена:</span>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/4.jpg" alt="picture" />
            <h5 className="mt-10">Кроссовки Puma X Aka Boku Future Rider</h5>
            <div className="d-flex justify-between align-center mt-20">
              <div className="d-flex flex-column">
                <span>Цена:</span>
                <b>8 999 руб.</b>
